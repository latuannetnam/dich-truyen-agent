...
<required_reading>
Read `D:/latuan/Programming/dich-truyen-agent/.claude/get-shit-done/references/ai-frameworks.md` for framework profiles and known pitfalls before fetching docs.
</required_reading>
