...
Reference full template: `D:/latuan/Programming/dich-truyen-agent/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `D:/latuan/Programming/dich-truyen-agent/.claude/get-shit-done/templates/state.md`.
