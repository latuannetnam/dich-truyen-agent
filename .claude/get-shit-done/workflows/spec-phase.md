...
```bash
INIT=$(node "D:/latuan/Programming/dich-truyen-agent/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @D:/latuan/Programming/dich-truyen-agent/.claude/get-shit-done/templates/spec.md.
