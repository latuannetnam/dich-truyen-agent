...
```
Agent(
  prompt="Read D:/latuan/Programming/dich-truyen-agent/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `D:/latuan/Programming/dich-truyen-agent/.claude/get-shit-done/templates/SECURITY.md`
