...
Key references:
- @D:/latuan/Programming/dich-truyen-agent/.claude/get-shit-done/references/ui-brand.md (display patterns)
- @D:/latuan/Programming/dich-truyen-agent/.claude/agents/gsd-user-profiler.md (profiler agent definition)
- @D:/latuan/Programming/dich-truyen-agent/.claude/get-shit-done/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="D:/latuan/Programming/dich-truyen-agent/.claude/get-shit-done/USER-PROFILE.md"
...
```bash
cp "D:/latuan/Programming/dich-truyen-agent/.claude/get-shit-done/USER-PROFILE.md" "D:/latuan/Programming/dich-truyen-agent/.claude/USER-PROFILE.backup.md"
```
...
✓ Stores profile at D:/latuan/Programming/dich-truyen-agent/.claude/get-shit-done/USER-PROFILE.md
...
Run session scan:
```bash
_GSD_SHIM_NAME="gsd-tools.cjs"; _GSD_RUNTIME_ROOT="${RUNTIME_DIR:-$(git rev-parse --show-toplevel 2>/dev/null || pwd)}"; GSD_TOOLS="${_GSD_RUNTIME_ROOT}/get-shit-done/bin/${_GSD_SHIM_NAME}"; if [ -f "$GSD_TOOLS" ]; then gsd_run() { node "$GSD_TOOLS" "$@"; }; elif [ -f "${_GSD_RUNTIME_ROOT}/.claude/get-shit-done/bin/${_GSD_SHIM_NAME}" ]; then GSD_TOOLS="${_GSD_RUNTIME_ROOT}/.claude/get-shit-done/bin/${_GSD_SHIM_NAME}"; gsd_run() { node "$GSD_TOOLS" "$@"; }; elif command -v gsd-tools >/dev/null 2>&1; then GSD_TOOLS="$(command -v gsd-tools)"; gsd_run() { "$GSD_TOOLS" "$@"; }; elif [ -f "D:/latuan/Programming/dich-truyen-agent/.claude/get-shit-done/bin/${_GSD_SHIM_NAME}" ]; then GSD_TOOLS="D:/latuan/Programming/dich-truyen-agent/.claude/get-shit-done/bin/${_GSD_SHIM_NAME}"; gsd_run() { node "$GSD_TOOLS" "$@"; }; else echo "ERROR: gsd-tools.cjs not found at $GSD_TOOLS and gsd-tools is not on PATH. Run: npx -y @opengsd/gsd-core@latest --claude --local" >&2; exit 1; fi
...
- The user-profiling reference doc at `D:/latuan/Programming/dich-truyen-agent/.claude/get-shit-done/references/user-profiling.md`
...
Reference: @D:/latuan/Programming/dich-truyen-agent/.claude/get-shit-done/references/user-profiling.md
...
Display: "✓ Profile written to D:/latuan/Programming/dich-truyen-agent/.claude/get-shit-done/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global CLAUDE.md" -- "Add profile to D:/latuan/Programming/dich-truyen-agent/.claude/CLAUDE.md for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at D:/latuan/Programming/dich-truyen-agent/.claude/get-shit-done/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated /gsd-dev-preferences at D:/latuan/Programming/dich-truyen-agent/.claude/skills/gsd-dev-preferences/SKILL.md"
...
Display: "✓ Added profile section to D:/latuan/Programming/dich-truyen-agent/.claude/CLAUDE.md"
...
```bash
BACKUP_PATH="D:/latuan/Programming/dich-truyen-agent/.claude/USER-PROFILE.backup.md"
```
...
Your profile:    D:/latuan/Programming/dich-truyen-agent/.claude/get-shit-done/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ /gsd-dev-preferences   D:/latuan/Programming/dich-truyen-agent/.claude/skills/gsd-dev-preferences/SKILL.md
  ✓ CLAUDE.md section       ./CLAUDE.md
  ✓ Global CLAUDE.md        D:/latuan/Programming/dich-truyen-agent/.claude/CLAUDE.md
```
