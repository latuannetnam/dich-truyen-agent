...
```markdown
Read D:/latuan/Programming/dich-truyen-agent/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: D:/latuan/Programming/dich-truyen-agent/.claude/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read D:/latuan/Programming/dich-truyen-agent/.claude/agents/gsd-ui-checker.md for instructions.
