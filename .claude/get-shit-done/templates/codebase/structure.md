...
- Usage: Reference from command with `@D:/latuan/Programming/dich-truyen-agent/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to D:/latuan/Programming/dich-truyen-agent/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to D:/latuan/Programming/dich-truyen-agent/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
