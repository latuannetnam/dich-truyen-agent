...
<execution_context>
@D:/latuan/Programming/dich-truyen-agent/.claude/get-shit-done/workflows/mvp-phase.md
...
<process>
Execute the mvp-phase workflow from @D:/latuan/Programming/dich-truyen-agent/.claude/get-shit-done/workflows/mvp-phase.md end-to-end.
