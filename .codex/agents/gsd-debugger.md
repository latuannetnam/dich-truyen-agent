...
<required_reading>
@D:/latuan/Programming/dich-truyen-agent/.codex/get-shit-done/references/common-bug-patterns.md
</required_reading>
...
@D:/latuan/Programming/dich-truyen-agent/.codex/get-shit-done/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = D:/latuan/Programming/dich-truyen-agent/.codex
                  → checks D:/latuan/Programming/dich-truyen-agent/.codex/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = D:/latuan/Programming/dich-truyen-agent/.codex/get-shit-done
                  → writes to D:/latuan/Programming/dich-truyen-agent/.codex/get-shit-done/hooks/
...
@D:/latuan/Programming/dich-truyen-agent/.codex/get-shit-done/references/thinking-models-debug.md
...
- Read @D:/latuan/Programming/dich-truyen-agent/.codex/get-shit-done/references/common-bug-patterns.md
