...
Use template from `D:/latuan/Programming/dich-truyen-agent/.codex/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `D:/latuan/Programming/dich-truyen-agent/.codex/get-shit-done/templates/UI-SPEC.md`
