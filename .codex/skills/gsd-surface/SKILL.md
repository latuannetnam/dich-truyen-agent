...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `D:/latuan/Programming/dich-truyen-agent/.codex/.gsd-surface.json`
(sibling to `D:/latuan/Programming/dich-truyen-agent/.codex/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `D:/latuan/Programming/dich-truyen-agent/.codex/skills/gsd-*/`.
...
(`~/.claude`), NOT the skills sub-directory (`D:/latuan/Programming/dich-truyen-agent/.codex/skills`).
...
`D:/latuan/Programming/dich-truyen-agent/.codex/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `D:/latuan/Programming/dich-truyen-agent/.codex/.gsd-surface.json`).
...
<execution_context>
Surface state file: `D:/latuan/Programming/dich-truyen-agent/.codex/.gsd-surface.json`
Install profile marker: `D:/latuan/Programming/dich-truyen-agent/.codex/.gsd-profile`
Skill dirs: `D:/latuan/Programming/dich-truyen-agent/.codex/skills/gsd-*/`
Engine module: `D:/latuan/Programming/dich-truyen-agent/.codex/get-shit-done/bin/lib/surface.cjs`
Cluster definitions: `D:/latuan/Programming/dich-truyen-agent/.codex/get-shit-done/bin/lib/clusters.cjs`
</execution_context>
