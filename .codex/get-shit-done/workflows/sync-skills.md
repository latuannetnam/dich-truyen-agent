...
INSTALL_JS_GLOBAL="D:/latuan/Programming/dich-truyen-agent/.codex/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node D:/latuan/Programming/dich-truyen-agent/.codex/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
