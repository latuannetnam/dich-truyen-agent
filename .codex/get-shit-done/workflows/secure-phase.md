...
```
Agent(
  prompt="Read D:/latuan/Programming/dich-truyen-agent/.codex/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `D:/latuan/Programming/dich-truyen-agent/.codex/get-shit-done/templates/SECURITY.md`
