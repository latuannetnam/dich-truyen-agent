...
- **Global scope**: `D:/latuan/Programming/dich-truyen-agent/.codex/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `D:/latuan/Programming/dich-truyen-agent/.codex/notes/`)
...
2. Glob `D:/latuan/Programming/dich-truyen-agent/.codex/notes/*.md` (if directory exists) — global notes
...
Global (D:/latuan/Programming/dich-truyen-agent/.codex/notes/):
...
2. **No `.planning/`**: Falls back to global `D:/latuan/Programming/dich-truyen-agent/.codex/notes/` — works in any directory
